...
**For the tutorial data,** we have both local and regional data. As a result, polynomial detrending will be applied to the regional dataset. Subsequent sections of this tutorial are used to describe the methodology for removing regional signals from the local dataset.
