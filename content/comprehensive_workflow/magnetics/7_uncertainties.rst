...
Here, we provide a basic approach for assigning uncertainties to magnetic data. Uncertainties and data misfit as it relates to geophysical inversion is presented in the :ref:`fundamentals of inversion <Fundamentals_Uncertainties>`.
