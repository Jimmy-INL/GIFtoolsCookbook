...
Here, we show how an equivalent source model can be used to compute the expected TMI anomalies for other locations/field orientations. Some examples include:
...
.. note:: If you want to preserve the horizontal locations (no gridding), simply make a copy of the original data object and alter the elevation column/define a different inducing field.
