...
Here we present the standard steps for completing a DC OcTree inversion. The steps are organized as follows:
...
**For the tutorial inversion** , the Tikhonov curve is shown below on a semilog-y plot. According to the figure and the *log* file:

	- the inversion reaches target misfit (chi-factor = 1 in this case) between iteration 9 and 10. And the algorithm is converging over the course of the beta cooling schedule.
