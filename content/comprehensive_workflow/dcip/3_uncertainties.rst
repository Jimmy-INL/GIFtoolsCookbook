...
In the :ref:`basic anomalies: understanding voltage data <comprehensive_workflow_dcip_1_voltage>` section, we learned that:
	...
	- Measured voltages are smaller when the electrode spacing is larger because the currents at the potential electrodes are weaker.
	- Measured voltages are smaller when the geology is more conductive.
