...
.. toctree::
    ...
    - Understanding DC and IP data <1_basic_anomalies>
    - Loading geophysical data and cursory interpretation of the data <2_load_data>
    - Assigning uncertainties <3_uncertainties>
    - 2D DC and IP inversion <4_local_2D>
    - Batch 2D DC and IP inversion <5_batch_2D>
    - OcTree mesh design <6_octree>
    - Weights and reference model for DC octree inversion <7_dc_prep>
    - Setting appropriate parameters and running the DC inversion <8_dc_inv>
    - Examining convergence, data misfit and the recovered conductivity model <9_dc_results>
    - Weights and reference model for IP octree inversion <10_ip_prep>
    - Setting appropriate parameters and running the IP inversion <11_ip_inv>
    - Examining convergence, data misfit and the recovered chargeability model <12_ip_results>
