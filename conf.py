# -*- coding: utf-8 -*-
#
# GIFtoolsCookbook documentation build configuration file, created by
...
htmlhelp_basename = 'GIFtoolsCookbookdoc'
...
latex_documents = [
  (master_doc, 'GIFtoolsCookbook.tex', u'GIFtoolsCookbook Documentation',
   u'UBC-GIF', 'manual'),
]
...
man_pages = [
    (master_doc, 'giftoolscookbook', u'GIFtoolsCookbook Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'GIFtoolsCookbook', u'GIFtoolsCookbook Documentation',
   author, 'GIFtoolsCookbook', 'One line description of project.',
   'Miscellaneous'),
]
